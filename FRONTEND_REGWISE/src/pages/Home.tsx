...
import { Search, ShieldCheck, TrendingUp, Globe, Sparkles, ArrowRight, Zap, FileText } from 'lucide-react';
...
export const Home = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (query.trim() && selectedCountry) {
      ...
      navigate(ROUTES.EXPLORER, { state: { query, country: selectedCountry.name } });
    }
  };
  ...
  const features = [
    {
      ...
      description: 'Get instant answers to complex compliance questions using advanced AI',
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description: 'Stay informed with automatic regulatory change notifications',
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-8">
              Navigate global regulatory requirements with AI-powered insights, automated workflows, 
              and real-time compliance monitoring across multiple jurisdictions.
            </p>
              ...
              <form onSubmit={handleSearch} className="relative">
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="pl-14 pr-32 h-14 text-lg bg-white shadow-2xl border-0 focus:ring-4 focus:ring-white/30"
                  />
                  <Button
                    type="submit"
                    disabled={!query.trim() || !selectedCountry}
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-primary to-secondary hover:shadow-lg"
                  >
                    <span>Search</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Choose a country to explore its regulatory framework and compliance requirements
          </p>
        </div>
        <CountryCardSelector />
      </div>
      ...
      <div className="bg-gradient-to-br from-primary to-secondary py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Generate custom onboarding workflows and stay ahead of regulatory changes
          </p>
          <Button
            size="lg"
