...
export const complianceAPI = {
  ...
  getSummaries: async (country: string): Promise<ComplianceSummary[]> => {
    try {
      const response = await api.get(`/countries/${country}/summaries`);
      return response.data;
    } catch (error) {
      // Mock response
      return [
        {
          ...
          summary:
            "Comprehensive AML framework requiring risk-based approach to customer due diligence, transaction monitoring, and suspicious activity reporting.",
          citations: [
            {
              id: "1",
              title: "AML Act 2024",
        ...
        },
        {
          ...
          summary:
            "Strict data protection requirements including consent management, data minimization, and breach notification obligations.",
          citations: [
            {
              id: "2",
        ...
        },
        {
          ...
          summary:
            "All financial service providers must obtain appropriate licensing and meet ongoing capital and compliance requirements.",
          citations: [
            {
              id: "3",
...
export const onboardingAPI = {
  getWorkflow: async (country: string): Promise<OnboardingWorkflow> => {
    try {
      const response = await api.get(`/countries/${country}/onboarding`);
      return response.data;
    } catch (error) {
      // Mock response
      return {
  ...
  exportWorkflow: async (
    ...
    try {
      const response = await api.get(
        `/countries/${country}/onboarding/export`,
        {
          params: { format },
          responseType: "blob",
        }
    ...
    try {
      ...
      return [
        ...
        },
        {
          ...
          description:
            "New guidelines on cookie consent mechanisms requiring explicit user interaction.",
          severity: "medium",
          date: "2024-11-18",
          isRead: false,
        ...
        },
        {
          ...
          description:
            "Financial Conduct Authority releases comprehensive framework for crypto asset regulation.",
          severity: "high",
          date: "2024-11-15",
          isRead: true,
        ...
        },
        {
          ...
          description:
            "Minor adjustments to international funds transfer reporting requirements.",
          severity: "low",
          date: "2024-11-05",
          isRead: true,
...
export const countriesAPI = {
  getCountries: async () => {
    try {
      ...
      // fallback to static countries if desired by the app
      return [];
    }
  },
};
